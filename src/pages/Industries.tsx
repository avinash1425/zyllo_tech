...
const industriesFaqSchema = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Which industries does Zyllo Tech serve?", acceptedAnswer: { "@type": "Answer", text: "Zyllo Tech serves Banking & Financial Services, Retail & E-Commerce, Healthcare & Life Sciences, EdTech, Logistics & Transportation, Manufacturing, Gaming & Entertainment, Real Estate & PropTech, Travel & Hospitality, Telecom & IT Services, Media & Publishing, and Agriculture & Environment." } },
    { "@type": "Question", name: "Does Zyllo Tech build software for the banking and FinTech sector?", acceptedAnswer: { "@type": "Answer", text: "Yes. We build KYC automation platforms, digital banking portals, payment gateway integrations, risk analytics dashboards, and PCI-DSS compliant infrastructure for banks, NBFCs, and FinTech companies." } },
    ...
    { "@type": "Question", name: "Can Zyllo Tech build headless e-commerce platforms for retail?", acceptedAnswer: { "@type": "Answer", text: "Yes. We build headless commerce platforms with inventory management, recommendation engines, multi-vendor support, and flash-sale infrastructure capable of handling 10x peak traffic without downtime." } },
    { "@type": "Question", name: "Does Zyllo Tech develop EdTech and LMS platforms?", acceptedAnswer: { "@type": "Answer", text: "Yes. We build learning management systems with live video classes, AI-generated assessments, gamification, adaptive learning paths, and real-time analytics — supporting 10,000+ concurrent learners." } },
    { "@type": "Question", name: "Can Zyllo Tech build logistics and fleet management software?", acceptedAnswer: { "@type": "Answer", text: "Yes. We build real-time fleet tracking, IoT-based route optimization, driver mobile apps, and ERP-integrated logistics platforms that reduce delivery costs by 20–30%." } },
    { "@type": "Question", name: "Does Zyllo Tech work on manufacturing and Industry 4.0 software?", acceptedAnswer: { "@type": "Answer", text: "Yes. We develop predictive maintenance ML platforms, MES integration, IoT sensor data pipelines, and digital twin dashboards for manufacturing operations and supply chain optimization." } },
    { "@type": "Question", name: "Can Zyllo Tech build gaming backends and entertainment platforms?", acceptedAnswer: { "@type": "Answer", text: "Yes. We design low-latency game backends, matchmaking systems, in-game economy platforms, leaderboards, and real-time multiplayer infrastructure using AWS GameLift and WebSockets." } },
    { "@type": "Question", name: "Does Zyllo Tech build PropTech and real estate software?", acceptedAnswer: { "@type": "Answer", text: "Yes. We develop PropTech CRM platforms, construction project tracking tools, buyer portals, virtual property tours, and automated document workflows for real estate developers and agents." } },
    { "@type": "Question", name: "Can Zyllo Tech build travel and hotel booking platforms?", acceptedAnswer: { "@type": "Answer", text: "Yes. We build booking engines, channel manager integrations, loyalty and rewards programs, and dynamic pricing systems for hotels, airlines, and travel agencies." } },
    { "@type": "Question", name: "Does Zyllo Tech work with telecom and IT service providers?", acceptedAnswer: { "@type": "Answer", text: "Yes. We build customer self-service portals, billing automation, BSS/OSS integration, and subscriber management platforms for telecom operators and managed IT service companies." } },
    { "@type": "Question", name: "Can Zyllo Tech build platforms for media and publishing companies?", acceptedAnswer: { "@type": "Answer", text: "Yes. We build headless CMS platforms, paywalled content portals, digital asset management systems, and high-volume content delivery infrastructure for media, publishing, and OTT companies." } },
    { "@type": "Question", name: "Does Zyllo Tech develop AgriTech software solutions?", acceptedAnswer: { "@type": "Answer", text: "Yes. We build IoT farm monitoring platforms, satellite imagery analysis systems, supply chain traceability solutions, and sustainability reporting dashboards for agricultural businesses and agritech startups." } },
  ],
};
