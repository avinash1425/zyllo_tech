...
const servicesFaqSchema = {
  ...
  mainEntity: [
    ...
    // Web Engineering
    { "@type": "Question", name: "Can you redesign our existing website without losing SEO rankings?", acceptedAnswer: { "@type": "Answer", text: "Yes. We run a full SEO audit before migration — URL mapping, 301 redirect strategy, metadata parity, canonical tags, and Core Web Vitals benchmarking. We do pre/post comparison to ensure ranking continuity." } },
    { "@type": "Question", name: "Will we own the code after the project is delivered?", acceptedAnswer: { "@type": "Answer", text: "Absolutely. You get full source code ownership, clean documentation, and a structured handover. We also offer optional post-launch support if your internal team needs time to ramp up." } },
    { "@type": "Question", name: "Can you integrate with our existing CRM, ERP, or payment systems?", acceptedAnswer: { "@type": "Answer", text: "Yes. We have experience integrating with Salesforce, HubSpot, SAP, Razorpay, Stripe, PayU, and most REST/SOAP APIs. We document all integration contracts clearly." } },
    // Mobile Apps
    { "@type": "Question", name: "Should we choose native or cross-platform for mobile app development?", acceptedAnswer: { "@type": "Answer", text: "We recommend native (Swift/Kotlin) for apps requiring deep device APIs or hardware-level performance. React Native is excellent for most business apps — it cuts build time significantly while delivering near-native UX. We assess your specific needs and recommend accordingly." } },
    { "@type": "Question", name: "Can you rebuild or modernize our existing app without disrupting current users?", acceptedAnswer: { "@type": "Answer", text: "Yes. We use feature flags, phased rollouts, and backward-compatible API versioning so existing users see no disruption. We also run parallel environments during migration for safety." } },
    { "@type": "Question", name: "How do you handle mobile app security for enterprise use cases?", acceptedAnswer: { "@type": "Answer", text: "We implement certificate pinning, encrypted local storage, jailbreak/root detection, secure token handling, and OWASP Mobile Top 10 controls — essential for finance, healthcare, and enterprise apps." } },
    // Cloud & DevOps
    { "@type": "Question", name: "Can you migrate our on-premise systems to cloud with minimal risk?", acceptedAnswer: { "@type": "Answer", text: "Yes. We use the Strangler Fig pattern for gradual migrations, define rollback paths at every wave, run parallel environments during cutover, and validate post-migration performance against pre-defined baselines." } },
    { "@type": "Question", name: "Can you set up cloud and DevOps infrastructure from scratch?", acceptedAnswer: { "@type": "Answer", text: "Yes. We've built cloud platforms from zero for multiple companies. We set up the full stack — environments, CI/CD, secrets management, monitoring, and runbooks — and can train your team to own it afterward." } },
    { "@type": "Question", name: "How do you control cloud costs?", acceptedAnswer: { "@type": "Answer", text: "We implement tagging policies, budget alerts, and rightsizing from day one. We also run monthly cost reviews, identify waste (idle resources, over-provisioned instances), and apply savings plans and reserved instances where appropriate." } },
    // Cybersecurity
    { "@type": "Question", name: "Do you only assess security vulnerabilities or do you fix them too?", acceptedAnswer: { "@type": "Answer", text: "We do both. After assessment, we prioritize findings by risk severity, work directly with your engineering team to remediate, and then verify fixes. You get a clear before/after security posture report." } },
    { "@type": "Question", name: "Can security engineering be added without slowing down our release cycles?", acceptedAnswer: { "@type": "Answer", text: "Yes. We integrate lightweight, automated security checks into your CI/CD pipeline — SAST, SCA, and secrets scanning run in under 5 minutes on most codebases. Critical-only blocking gates ensure speed isn't sacrificed." } },
    { "@type": "Question", name: "Can you help us achieve ISO 27001 or SOC 2 compliance?", acceptedAnswer: { "@type": "Answer", text: "Yes. We run a gap analysis against the target framework, map your current controls, identify gaps, and build a remediation roadmap with clear ownership. We also help prepare evidence for auditor review." } },
    // QA & Testing
    { "@type": "Question", name: "Our product has no tests at all — where do you start with QA?", acceptedAnswer: { "@type": "Answer", text: "We start with a risk-based prioritization — critical user journeys, payment flows, and auth paths first. We build a test harness, write foundational automation, integrate it into CI, and then expand coverage sprint by sprint." } },
    { "@type": "Question", name: "Can you embed a QA engineer within our existing development team?", acceptedAnswer: { "@type": "Answer", text: "Yes. We provide dedicated QA engineers who work inside your sprint cycle — reviewing stories, writing tests alongside developers, and owning quality metrics. They align with your tools, rituals, and release cadence." } },
    { "@type": "Question", name: "How do you handle mobile app testing across many device types?", acceptedAnswer: { "@type": "Answer", text: "We build a device matrix based on your user analytics (top OS versions and screen sizes), then run automated tests using Appium on real device clouds (BrowserStack / AWS Device Farm) to ensure consistent behavior." } },
    // Data & AI
    { "@type": "Question", name: "Can you build AI features that work securely with our proprietary business data?", acceptedAnswer: { "@type": "Answer", text: "Yes. We implement RAG (Retrieval Augmented Generation) architectures where your data stays in your own infrastructure. We use strict access controls, no data training sharing with model providers, and audit logs for all AI interactions." } },
    { "@type": "Question", name: "How do you ensure AI outputs are reliable enough for business decisions?", acceptedAnswer: { "@type": "Answer", text: "We build evaluation frameworks — automated output testing, confidence thresholds, human-in-the-loop checkpoints, and fallback logic. We never ship AI features without measurable accuracy baselines and monitoring in place." } },
    // Dedicated Teams
    { "@type": "Question", name: "Who owns the intellectual property and code written by a dedicated team?", acceptedAnswer: { "@type": "Answer", text: "You do — 100%. All work is covered by IP assignment agreements. We sign NDAs before any engagement starts, and code is committed to your repositories throughout, not held by us." } },
    { "@type": "Question", name: "Can we start with a small dedicated team and scale up later?", acceptedAnswer: { "@type": "Answer", text: "Yes. Teams are modular — you can start with 2 engineers and expand by role or domain as your roadmap grows. Scale-up usually takes 1–2 weeks per additional engineer since our onboarding is structured." } },
  ],
};
