        ...
        {activeJob && (
          <div className="p-6 pt-14 sm:p-8 sm:pt-14">
            ...
            <button
              ...
              className="mt-8 inline-flex items-center justify-center gap-2 rounded-full bg-[#c2410c] px-8 py-3.5 text-sm font-semibold text-white shadow-[0_18px_28px_-10px_rgba(194,65,12,0.55)] transition-all duration-200 hover:-translate-y-0.5 hover:scale-105 hover:bg-[#9a3412]"
            >
              Apply Now
              <ArrowRight className="h-4 w-4" aria-hidden="true" />
            </button>
