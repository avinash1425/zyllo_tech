import { Brain, Cloud, Code2, Palette, ShieldCheck, TrendingUp } from "lucide-react";

const CATEGORIES = [
  { icon: Code2, title: "Engineering", count: "12 articles" },
  { icon: Palette, title: "Design", count: "8 articles" },
  { icon: Brain, title: "AI & Automation", count: "10 articles" },
  { icon: Cloud, title: "Cloud & DevOps", count: "7 articles" },
  { icon: ShieldCheck, title: "Security", count: "5 articles" },
  { icon: TrendingUp, title: "Product Strategy", count: "9 articles" },
];
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg leading-relaxed text-[#676b7a]">
            Notes and lessons from the team, organized by topic.
          </p>
        </div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {CATEGORIES.map(({ icon: Icon, title, count }) => (
            ...
            >
              ...
              <p className="mt-1 text-sm text-[#676b7a]">{count}</p>
            </div>
          ))}
        </div>
      </div>
