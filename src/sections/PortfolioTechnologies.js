...
import { Cloud, Code2, Database, Layers, Smartphone } from "lucide-react";

// Portfolio-page-only technologies section (5 categories, no AI & ML) —
// kept separate from the About page's Technologies.js so each page's
// category list can evolve independently. Icon medallion style matches
// every other icon-card section on the site.
const CATEGORIES = [
  {
    icon: Code2,
    title: "Frontend",
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#2b303b] sm:text-4xl">
            The stack behind our projects
          </h2>
          <p className="mt-4 text-lg leading-relaxed text-[#676b7a]">
            A snapshot of the tools and platforms we reach for most often
            across the work in this portfolio.
          </p>
        </div>
