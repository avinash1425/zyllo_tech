      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center lg:px-8">
        <div className="rounded-[28px] border border-white/60 bg-white/60 p-10 shadow-xl backdrop-blur-xl sm:p-14">
          ...
          <div className="mt-8">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#c2410c] px-8 py-4 text-sm font-semibold text-white shadow-[0_18px_28px_-10px_rgba(194,65,12,0.55)] transition-all duration-200 hover:-translate-y-0.5 hover:scale-105 hover:bg-[#9a3412]"
            >
              Join Talent Network
            </Link>
          </div>
          ...
          <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-4 sm:grid-cols-3">
            {CONTACT_METHODS.map(({ icon: Icon, label, value, href }) => (
              <a
                ...
                className="group relative flex flex-col items-center gap-2 overflow-hidden rounded-xl border border-white/70 bg-gradient-to-br from-white/90 to-[#f7941e]/[0.04] px-4 py-5 shadow-md shadow-[#1f4693]/5 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-transparent hover:shadow-lg hover:shadow-[#f7941e]/10"
              >
                <span
                  aria-hidden="true"
                ...
                />
                <Icon className="h-5 w-5 text-[#f7941e] transition-transform duration-300 group-hover:scale-110" aria-hidden="true" />
