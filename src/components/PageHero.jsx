                ...
                {primaryCta &&
                  (primaryCta.href.startsWith("#") ? (
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-2 rounded-full bg-[#c2410c] px-7 py-3.5 text-sm font-semibold text-white shadow-[0_18px_28px_-10px_rgba(194,65,12,0.55)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#9a3412]"
                    >
                      {primaryCta.label}
                    </a>
                  ) : (
