...
// confirmed directly by the user. Facebook is omitted entirely rather than
// linked with a "#" placeholder — no real Zyllo Tech Facebook page URL is
// confirmed to exist; add it back once one is.
const SOCIAL_LINKS = [
  {
